...
struct HhasClassFlags;

struct HhasMethodFlags;

struct HhasPropertyFlags;
...
using ParamLocations = Slice<intptr_t>;
...
struct InstructMisc {
  ...
  struct MemoGet_Body {
    Label _0;
    Maybe<Pair<Type, intptr_t>> _1;
  };

  struct MemoGetEager_Body {
    Label _0;
    Label _1;
    Maybe<Pair<Type, intptr_t>> _2;
  };

  struct MemoSet_Body {
    Maybe<Pair<Type, intptr_t>> _0;
  };
...
struct InstrSeq {
  ...
  struct List_Body {
    SliceMut<Instruct> _0;
  };

  struct Concat_Body {
    SliceMut<InstrSeq> _0;
  };
