...
async fn main() -> std::io::Result<()> {
    ...
    println!("echo client connected to server. type some lines. type ^D (Ctrl+D) to exit.");
    ...
    match &cli.command {
        None => (),
        Some(Commands::Random { delay, duration }) => {
