...
/* package template-haskell-exp-0.1.0.0 */
#ifndef VERSION_template_haskell_exp
#define VERSION_template_haskell_exp "0.1.0.0"
#endif /* VERSION_template_haskell_exp */
#ifndef MIN_VERSION_template_haskell_exp
#define MIN_VERSION_template_haskell_exp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_template_haskell_exp */
...
#define CURRENT_PACKAGE_KEY "template-haskell-exp-0.1.0.0-K4rkvp8X3l4HwD3WybYvMb"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "template-haskell-exp-0.1.0.0-K4rkvp8X3l4HwD3WybYvMb"
